...
const color_dead_node : Color = Color.DARK_GRAY
const color_live_node : Color = Color.WHITE
const color_current_node : Color = Color.GREEN
const color_past_path : Color = Color.DARK_GREEN
const color_mouse_node : Color = Color.GREEN_YELLOW
