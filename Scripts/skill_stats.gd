...
static var s_fighter_command_attack : AttackStats = AttackStats.create("Go Now", AttackStats.AttackTarget.TWO_REAR_MOST).adjust_damage(0).set_on_allies().has_cooldown().set_is_command()
